...
\thispagestyle{empty}
\begin{fullpage}
\includegraphics{2009-redbook-halftitlepage.pdf}
\end{fullpage}
\vfil\eject
...
\vskip 0pt
{\it\hspace{.5in} $\ldots$the incoming class of 2009. Best of luck!}
\newpage
...
absolutely positive it is your last quarter, or you (or your advisor if they
are gracious enough) will have to pay a penalty to the University.

\section{\secso{Comps}}

The main repository of material related to the Comps is Comps Central:

http://www-cs-students.stanford.edu/phd/comps.php
...
you may drop the class (even after the official drop date---although this will
appear as a withdrawal on your transcript). 
...
to first-year students in the Fall. The 2007-2009 printings were supported by the
